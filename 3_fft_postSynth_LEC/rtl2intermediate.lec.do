...
# Generated on: Thu Apr 16 14:04:58 IST 2026 (Thu Apr 16 08:34:58 UTC 2026)
...
set logfile rtl2intermediate.lec.log -replace 

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/fft_8_top -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/home/install/cadence/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/home/install/cadence/GENUS211/tools.lnx86"
set env(CW_DIR) "/home/install/cadence/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/home/install/cadence/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /home/install/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/home/install/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/home/install/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/home/install/cadence/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/home/install/cadence/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
add_search_path /opt/sclpdkv3/scl180/stdcell/fs120/6M1L/liberty/lib_flow_ff/opt/sclpdkv3/scl180/stdcell/fs120/6M1L/liberty/lib_flow_ss -library -both
...
add_search_path /home/vlsilab/Music/FFT/FFT/2_fft_synth/top_wps.sv -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  top_wps.sv
elaborate_design -golden -root {fft_8_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fft_8_top/fv_map.v.gz
elaborate_design -revised -root {fft_8_top}
...
#add_name_alias fv/fft_8_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.fft_8_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.fft_8_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.fft_8_top.rtl.fv_map.rpt
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
    analyze_results -logfiles rtl2intermediate.lec.log
}
