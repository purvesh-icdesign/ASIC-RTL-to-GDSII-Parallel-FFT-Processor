...
create_op_cond -name op_cond_worst -library_file ${::IMEX::libVar}/mmmc/tsl18fs120_scl_ff.lib -P 1 -V 1.62 -T 125
create_rc_corner -name rc_best\
   -cap_table ${::IMEX::libVar}/mmmc/fft.CapTbl\
   -preRoute_res 1\
   -postRoute_res 1\
   -preRoute_cap 1\
   -postRoute_cap 1\
...
create_constraint_mode -name all\
   -sdc_files\
    [list /dev/null]
create_analysis_view -name best_case -constraint_mode all -delay_corner min_delay -latency_file ${::IMEX::libVar}/mmmc/latency.sdc
create_analysis_view -name worst_case -constraint_mode all -delay_corner max_delay -latency_file ${::IMEX::libVar}/mmmc/latency.sdc
